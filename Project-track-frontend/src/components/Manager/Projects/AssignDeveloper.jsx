    ...
    render() {
        return (
            <div>
                ...
                <div className="card col-md-6 offset-md-3 offset-md-3 shadow p-3 mt-5 mb-5 bg-white rounded" style={{ marginTop: "50px" }}>
                    <div className="card-body">
                        <h3 className="card-title" style={{ marginBottom: "40px" }}>Assign a Developer</h3>
                        <form>
                            <div className="row">
                                ...
                                <div className="form-group col-md-4">
                                    ...
                                    <input type="text" className="form-control" placeholder="Enter Name" value={this.state.empname} onChange={this.changeEmpName} />
                                </div>
                                <div className="form-group col-md-4">
                            ...
                            <div className="row">
                                <div className="form-group col-md-4">
                                    ...
                                    <input type="text" className="form-control"  value={this.state.pname} onChange={this.changeName} />
                                </div>
                                <div className="form-group col-md-4">
