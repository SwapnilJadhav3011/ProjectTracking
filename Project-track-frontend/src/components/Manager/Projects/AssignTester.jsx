...
class AssignTester extends Component {
    constructor(props){
        super(props)
        ...
        this.assignDeveloper=this.assignTester.bind(this);
    }
    componentDidMount() {
    ...
    assignTester = (p) => {
        ...
        Projectservice.assignProject(empproject).then((res) => {
            // Projectservice.sendMail(empproject.empid).then((res) => {
            ...
            <div>
                ...
                <div className="card col-md-6 offset-md-3 offset-md-3 shadow p-3 mb-5 bg-white rounded" style={{ marginTop: "50px" }}>
                    <div className="card-body">
                        <h4 className="card-title" style={{ marginBottom: "40px" }}>Assign a Tester</h4>
                        <form>
                            <div className="row">
                        ...
                        <div className="text-center" style={{ marginTop: "20px" }}>
                            <button type="submit" className="btn btn-success" onClick={this.assignTester}>Assign</button>
                        </div>
                    </div>
                </div><br />
                <FooterComponent />
